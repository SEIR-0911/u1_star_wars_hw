...
touch han_solo.txt chewbacca.tx
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv luke_skywalker.txt obi_wan.txt princess_leia.txt /home/sage/development/ga/unit1/u1_star_wars_hw/star_wars/rebellion/millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon /home/sage/development/ga/unit1/u1_star_wars_hw/star_wars/empire/death_star