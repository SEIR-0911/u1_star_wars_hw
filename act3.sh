...
mv millenium_falcon/* /Users/logan/desktop/GA/unit1/week1/monday/u1_star_wars_hw/star_wars/empire/death_star
...
mv millenium_falcon /Users/logan/desktop/GA/unit1/week1/monday/u1_star_wars_hw/star_wars/rebellion

# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /Users/logan/desktop/GA/unit1/week1/monday/u1_star_wars_hw/star_wars/empire
