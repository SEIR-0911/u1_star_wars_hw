...
mv * /Users/robertcastor/u1_star_wars_hw/star_wars/empire/death_star
...
mv princess_leia.txt luke_skywalker.txt han_solo.txt chewbacca.txt /Users/robertcastor/u1_star_wars_hw/star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv /Users/robertcastor/u1_star_wars_hw/star_wars/empire/death_star/millenium_falcon .
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /Users/robertcastor/u1_star_wars_hw/star_wars/empire
